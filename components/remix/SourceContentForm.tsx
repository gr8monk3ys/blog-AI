...
function SourceContentFormComponent({
  ...
  const titleInputId = 'source-content-title'
  const bodyTextareaId = 'source-content-body'
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor={bodyTextareaId} className="block text-sm font-medium text-gray-700 mb-1">
            Content Body
          </label>
          <textarea
            id={bodyTextareaId}
