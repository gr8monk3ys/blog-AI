  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-center">
        {status === 'processing' && (
          <>
            <svg aria-hidden="true" className="animate-spin h-8 w-8 mx-auto text-amber-700 mb-4" viewBox="0 0 24 24" fill="none">
        ...
        {status === 'success' && (
          <>
            <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center">
              <svg aria-hidden="true" className="w-6 h-6 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {status === 'error' && (
          <>
            <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-red-100 dark:bg-red-900/40 flex items-center justify-center">
              <svg aria-hidden="true" className="w-6 h-6 text-red-600 dark:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
