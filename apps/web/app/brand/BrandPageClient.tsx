    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-amber-100 max-w-2xl mx-auto">
              Define the positioning, tone, and examples that make your content feel like your
              team instead of generic AI copy.
            </p>
          </m.div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <m.div
          ...
          className="mb-6 rounded-2xl border border-amber-200 bg-amber-50/80 p-5 dark:border-amber-900/40 dark:bg-amber-950/30"
        >
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-amber-800 dark:text-amber-200">
                ...
                After you save a profile, use bulk generation to turn that voice into repeatable
                SEO content output.
              </p>
            </div>
            <Link
