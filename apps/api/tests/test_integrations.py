...
class TestGitHubIntegration(unittest.TestCase):
    ...
    def test_upload_file(self, mock_put, mock_get):
        ...
        mock_put.return_value = MagicMock(
            ...
            json=lambda: {
                "content": {
                    "html_url": "https://github.com/test_owner/test_repo/blob/main/test/path.md"
                }
            },
        )
        ...
        self.assertEqual(
            ...
            "https://github.com/test_owner/test_repo/blob/main/test/path.md",
        )
    ...
    def test_create_repository(self, mock_post):
        ...
        result = create_repository(
            self.credentials, "test_repo", "Test repository", False
        )
    ...
    def test_upload_blog_post(self, mock_upload_file):
        ...
        mock_upload_file.return_value = IntegrationResult(
            ...
            data={
                "file_url": "https://github.com/test_owner/test_repo/blob/main/content/blog/test-blog-post.md"
            },
        )
...
class TestMediumIntegration(unittest.TestCase):
    ...
    def test_upload_post(self, mock_post, mock_get):
        ...
        # Set up mocks
        mock_get.return_value = MagicMock(
            status_code=200, json=lambda: {"data": {"id": "user123"}}
        )
        mock_post.return_value = MagicMock(
            status_code=201,
            json=lambda: {
        ...
        self.assertEqual(
            result.data["post_url"], "https://medium.com/@user/test-post-123"
        )
    ...
    def test_get_user_publications(self, mock_get):
        ...
        mock_get.side_effect = [
            MagicMock(status_code=200, json=lambda: {"data": {"id": "user123"}}),
            MagicMock(
                status_code=200,
                json=lambda: {
                    "data": [
    ...
    def test_upload_blog_post(self, mock_upload_post):
        ...
        mock_upload_post.return_value = IntegrationResult(
            ...
            data={
                "post_id": "post123",
                "post_url": "https://medium.com/@user/test-post-123",
            },
        )
...
class TestWordPressIntegration(unittest.TestCase):
    ...
    def test_upload_blog_post(
        self, mock_upload_post, mock_create_category, mock_get_categories
    ):
        """Test the upload_blog_post function."""
        # Set up mocks
        ...
        mock_create_category.return_value = WordPressCategory(
            id=2, name="Blog", slug="blog"
        )

        # Mock get_or_create_tag to avoid errors
        with patch(
            "src.integrations.wordpress.get_or_create_tag"
        ) as mock_get_or_create_tag:
            mock_get_or_create_tag.return_value = WordPressTag(
