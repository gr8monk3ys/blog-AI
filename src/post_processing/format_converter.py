...
def convert_format(content: str, options: FormatConversionOptions) -> str:
    """
    ...
    try:
        ...
        if source_format == "markdown" and target_format == "html":
            ...
            return markdown_to_docx(
                content, options.include_metadata, options.include_images
            )
...
def markdown_to_html(content: str, include_metadata: bool = True) -> str:
    ...
    try:
        ...
        raise FormatConversionError(
            "Markdown package not installed. Install it with 'pip install markdown'."
        )
    except Exception as e:
...
def markdown_to_docx(
    content: str, include_metadata: bool = True, include_images: bool = True
) -> str:
    """
    ...
    try:
        ...
        raise FormatConversionError(
            "Pandoc not installed. Install it from https://pandoc.org/installing.html."
        )
    except Exception as e:
...
def html_to_markdown(content: str, include_metadata: bool = True) -> str:
    ...
    try:
        ...
        raise FormatConversionError(
            "HTML2Text package not installed. Install it with 'pip install html2text'."
        )
    except Exception as e:
...
def extract_html_metadata(content: str) -> tuple:
    ...
    try:
        ...
        raise FormatConversionError(
            "BeautifulSoup package not installed. Install it with 'pip install beautifulsoup4'."
        )
    except Exception as e:
