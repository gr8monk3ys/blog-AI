...
class ContentTopic:
    ...
    def __init__(
        self, title: str, keywords: List[str], description: Optional[str] = None
    ):
        self.title = title
...
class ContentCalendar:
    ...
    def __init__(
        self, items: List[ContentItem], start_date: datetime, end_date: datetime
    ):
        self.items = items
...
class Competitor:
    ...
    def __init__(
        self, name: str, website: str, content: Optional[List[CompetitorContent]] = None
    ):
        self.name = name
